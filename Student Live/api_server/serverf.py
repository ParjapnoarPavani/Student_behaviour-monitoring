...
def image():
    ...
    drowsy, yawning, posture, number = FaceAction().run_frame(image_object)
    drow_val = drowsy
    if (drowsy < 0.2):        
        drowsy = 1        
    else:
    ...
    if room in rooms:
        if name in rooms[room]:
            ...
            #print("I am here")
            rooms[room][name]['drowsy'] = drowsy
            rooms[room][name]['yawning'] = yawning
            rooms[room][name]['posture'] = posture
            ...
            if ((nowtime - rooms[room][name]['last5']) >= 5):
                ...
                if (teacher == "true"):
                    ...
                    print(drowsy)
                    print(posture)
                    if yawning == 1 or drowsy ==1 or posture ==1:
            ...
            rooms[room][name]['avgdrow'] = rooms[room][name]['drowsy']
            # Current Average
            rooms[room][name]['avgyawn'] = rooms[room][name]['yawning']
            rooms[room][name]['avgpos'] = rooms[room][name]['posture']
